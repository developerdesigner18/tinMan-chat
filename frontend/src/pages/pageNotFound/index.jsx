...
const PageNotFound = () => {
  return (
    <div className="w-screen h-screen flex justify-center items-center bg-light-primary dark:bg-dark-primary">
      <Result
        status="404"
        title={<p className="text-dark-primary dark:text-light-primary">404</p>}
        subTitle={
