...
const Login = () => {
  ...
  return (
    <div className="transition-none w-screen h-screen p-4 flex justify-center items-center bg-light-primary dark:bg-dark-primary">
      <form
        onSubmit={onSubmitHandler}
        className="w-full sm:w-[500px] max-w-[500px] border border-[#374151] bg-light-secondary  dark:bg-dark-secondary shadow-lg shadow-gray-500/40 rounded px-8 pt-6 pb-8 mb-4"
      >
        <h3 className="mb-4 sm:mb-0 text-center text-xl text-message-dark dark:text-light-primary font-semibold">
          Login
        </h3>

        <div className="mb-4">
          <label
            className="block text-message-dark dark:text-light-primary text-sm font-bold mb-2"
            htmlFor="nickname"
          >
            Nickname
          </label>
